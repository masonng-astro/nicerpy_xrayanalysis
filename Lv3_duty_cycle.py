...
#        print(dat_files[i],len(binned_data))
        ...
        usable_data = len(summed_data[summed_data>0])
...
#duty_cycle('0034070101',0.00025,100,1,10)
...
#def ## use a function that'd return a list of .dat files that have enough data
#in them
