...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 3 9:17am 2019

Opening FITS files and obtaining data from the .mkf files in the NICERsoft pipe directories
...
def get_nicerdata_mkf(obsid,par_list):
    """
    ...
    event = Lv0_dirs.NICERSOFT_DATADIR + obsid + '_pipe/ni' + obsid + '.mkf'
...
def get_nicersoft_mkf(obsid,par_list):
    """
    Getting data from the FITS files, e.g., PI_FAST, TIME, PI, PI_RATIO, FLAGS
    ...
    event = Lv0_dirs.NICERSOFT_DATADIR + obsid + '_pipe/cleanfilt.mkf'
    event = fits.open(event)
    data_dict = {}
